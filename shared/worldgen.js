...
export const WORLD_SIZES = {
  small: {
    ...
    tinyCount: [22, 30], tinyRadius: [4, 10, 14], teamHeightOffset: 15, teamDragons: 0, centralDragons: 2, eels: 2,
    ...
    tinyDistribution: [0.35, 0.35, 0.15, 0.15], placementAttempts: 80,
  ...
  medium: {
    ...
    tinyCount: [34, 45], tinyRadius: [5, 12, 17], teamHeightOffset: 22, teamDragons: 1, centralDragons: 3, eels: 4,
  ...
  large: {
    ...
    tinyCount: [50, 66], tinyRadius: [5, 15, 20], teamHeightOffset: 30, teamDragons: 1, centralDragons: 5, eels: 6,
